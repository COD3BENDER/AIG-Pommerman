...
public class MCTSParamsAK implements ParameterSet {
    ...
    public double K = Math.sqrt(2);//5
    public double K2 = Math.sqrt(2.5);
    public double K3 = Math.sqrt(2);
    ...
    public Map<String, Object[]> getParameterValues() {
        ...
        parameterValues.put("K", new Double[]{1.0, Math.sqrt(4), 2.0});
        parameterValues.put("K2", new Double[]{1.0, Math.sqrt(2), 2.0});
        parameterValues.put("K3", new Double[]{1.0, Math.sqrt(0), 2.0});
